...
import { Settings, UserPlus, ShieldPlus, ArrowRight, Loader2, AlertCircle, Eye, EyeOff } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (!terms) {
      setError("Please acknowledge the service terms.");
      return;
    }
        ...
        <div className="bg-[#111111] p-10 lg:p-12 shadow-[20px_20px_60px_rgba(0,0,0,0.8)] border border-white/5 relative rounded-none">
          ...
          <div className="mb-10">
            ...
            <h2 className="text-3xl font-bold text-white uppercase leading-none">
              Account <span className="text-machine-green">Registration.</span>
            </h2>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[11px] font-bold uppercase tracking-wide text-slate-300 ml-1">Legal Name</label>
              <input 
                type="text" 
                value={name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-[11px] font-bold uppercase tracking-wide text-slate-300 ml-1">Email</label>
                <input 
                  type="email" 
                  value={email}
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-bold uppercase tracking-wide text-slate-300 ml-1">Phone</label>
                <input 
                  type="tel" 
                  value={phone}
            ...
            <div className="flex items-start gap-3 py-2">
              <input 
                ...
                className="mt-1 w-4 h-4 bg-black border-white/10 rounded-none checked:bg-machine-green accent-machine-green"
              />
              <p className="text-[10px] text-slate-500 uppercase tracking-widest leading-relaxed">
                I acknowledge the <span className="text-white">Service Terms</span> and industrial data standards of Sri Devi Engineers.
              </p>
            </div>
            ...
            >
              {isSubmitting ? (
                ...
                <span className="flex items-center gap-4 text-black">Create Account <ArrowRight className="w-4 h-4" /></span>
              )}
            </Button>
          </form>
          ...
          <div className="mt-10 pt-8 border-t border-white/5 flex flex-col gap-4">
            <div className="flex justify-between items-center px-1">
               <Link href="/login" className="text-[10px] font-bold text-slate-400 uppercase hover:text-machine-green transition-colors">Already a member? Login</Link>
